...
class Breakout():
    ...
    def kalibracja(self):
        ...
        self.screen.fill(self.bgcolour)
        text = pygame.font.Font(None, 40).render('Rozluźnij mięsień', True, (0, 255, 255), self.bgcolour)
       ...
       # t0_0 = t0
        ...
        text = pygame.font.Font(None, 40).render('Napnij mięsień', True, (214, 21, 21), self.bgcolour)
        textrect = text.get_rect()
        textrect.center = (self.width / 2, self.height / 2)
