    ...
    def play(self):
        ...
        while trashes and play and self.lifes > 0:
            ...
            while this_trash:
                ...
                label = myfont.render('Życia: ', 1, (255,255,0))
                self.screen.blit(label, (100, 100))

                myfont = pygame.font.SysFont("monospace", 15)
                label = myfont.render("❤"*self.lifes, 1, (255,255,0))
                self.screen.blit(label, (100+15*len('Życia: ') + 10, 100))

                myfont = pygame.font.SysFont("monospace", 15)
                label = myfont.render("Punkty: ", 1, (255,255,0))
                self.screen.blit(label, (100, 200))

                myfont = pygame.font.SysFont("monospace", 15)
                label = myfont.render(str(self.score), 1, (255,255,0))
                self.screen.blit(label, (100+15*len('Punkty: ') + 10, 200))
